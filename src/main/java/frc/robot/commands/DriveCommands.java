...
public class DriveCommands {
    ...
    return Commands.run(
        () -> {
          ...
          Translation2d linearVelocity =
              SwerveUtils.GetLinearVelocityFromRawJoysticks(xSupplier.getAsDouble(), ySupplier.getAsDouble());
  ...
  public static Command joystickDriveWithRotationalOverride(
    ...
    PIDController angleController =
        new PIDController(
            DriveConstants.OVERRIDE_ANGLE_KP,
            0.0,
            DriveConstants.OVERRIDE_ANGLE_KD);
    ...
    return Commands.run(
            () -> {
              ...
              double omega =
                  angleController.calculate(
                      drive.getRotation2d().getRadians(), rotationSupplier.get().getRadians());
        ...
        .beforeStarting(() -> angleController.setSetpoint(drive.getRotation2d().getRadians()));
  }
}