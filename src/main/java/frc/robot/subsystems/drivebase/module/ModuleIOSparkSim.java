...
public class ModuleIOSparkSim extends ModuleIOSparkMax {
    ...
    public void updateInputs(ModuleIOInputs inputs) {
        ...
        driveSim.iterate(
                driveGearboxSim.getAngularVelocityRadPerSec() * ModuleConstants.WHEEL_RADIUS_METRES,
                SimulatedBattery.getBatteryVoltage().magnitude(),
                0.02);
        turnSim.iterate(
                turnGearboxSim.getAngularVelocityRadPerSec(),
                SimulatedBattery.getBatteryVoltage().magnitude(),
                0.02);
