...
public class Intake extends SubsystemBase {
   ...
   public Intake() {
      ...
      this.intakeRoutine = new SysIdRoutine(new SysIdRoutine.Config(), new SysIdRoutine.Mechanism(this.intake::setVoltage, (Consumer)null, this));
      this.intakeRollerRoutine = new SysIdRoutine(new SysIdRoutine.Config(), new SysIdRoutine.Mechanism(this.intakeRoller::setVoltage, (Consumer)null, this));
      this.intakeConfig.closedLoop.pid(0.0, 0.0, 0.0);
      this.intakeConfig.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder);
      this.intakeConfig.softLimit.forwardSoftLimit(0.331).reverseSoftLimit(0.0).forwardSoftLimitEnabled(true).reverseSoftLimitEnabled(true);
