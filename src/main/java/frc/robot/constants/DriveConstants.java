...
public class DriveConstants {
        ...
        public static final double ROTATION_SLEW_RATE = 7; // percent per second (1 = 100%), speed rotating starts and
                                                           // stops. Max is 7 for safety.

        public static final double TRACK_WIDTH = Units.inchesToMeters(23.75); // Distance between left and right wheels
                                                                              // on
                                                                              // robot
        ...
        public static final Translation2d BLUE_HUB_CENTER_POINT = new Translation2d(
                        edu.wpi.first.units.Units.Inches.of(182.11), edu.wpi.first.units.Units.Inches.of(158.84));
}